#ifndef _SongTool_AlbumBriefing_h_
...
class AlbumBriefing : public WithKeyValueList<SongToolCtrl> {
	#define ALBUM_BRIEFING_LIST \
		...
		ITEM(LIMITS_BEGIN, t_("Limitations of the beginning"), t_("Significant events that happened immediately before all songs in this album")) \
		ITEM(LIMITS_END, t_("Limitations of the end"), t_("Significant events that happened immediately after all songs in this album")) \
		...
		ITEM(THEME_COMPOSITION, t_("Composition Theme"), t_("Common musical style of songs")) \
		ITEM(THEME_LYRICAL, t_("Lyrical Theme"), t_("Common lyrical style of songs")) \
		ITEM(THEME_PRODUCTION, t_("Production Theme"), t_("Common genre and production limitations and features of songs")) \
