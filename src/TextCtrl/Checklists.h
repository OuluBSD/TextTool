#ifndef _TextTool_ChecklistProduction_h_
#define _TextTool_ChecklistProduction_h_
...
#define CHK_PRODUCTION_LIST \
	...
	CHK_PRODUCTION(5,		FINISH_WHAT_TO_SAY, t_("Decide what you want to say in scripts")) \
	CHK_PRODUCTION(10,		FINISH_FINISH_ENGLISH_STRUCTURE, t_("Finish scripts structure in english")) \
	...
	CHK_PRODUCTION(1,		FINISH_RHYME_TEXT, t_("Make rhyme notation text of scripts if it's rap")) \
...
#define CHK_RELEASE_LIST \
	CHK_RELEASE(ORDER_OF_SONGS, t_("Decide final order of components")) \
	...
	CHK_RELEASE(PITCH_IN_SPOTIFY, t_("Pitch your song at Spotify for Entitys page")) \
	//CHK_RELEASE(, t_("")) \

class ChecklistSnapshot : public ChecklistBase {
...
public:
	typedef ChecklistSnapshot CLASSNAME;
	ChecklistSnapshot();
