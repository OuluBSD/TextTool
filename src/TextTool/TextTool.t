...
T_("Save song data analysis")
fiFI("")

T_("Save song data analysis on exit")
fiFI("")

T_("Do not save song data analysis on exit")
fiFI("")
...
T_("Move to higher page")
fiFI("")

T_("Move to lower page")
fiFI("")

T_("Move to higher page group")
fiFI("")

T_("Move to lower page group")
fiFI("")

T_("Move to higher part")
fiFI("")

T_("Move to lower part")
fiFI("")
...
T_("Ambiguous word pairs")
fiFI("")

T_("Virtual phrases")
fiFI("")

T_("Virtual phrase parts")
fiFI("")

T_("Virtual phrase structs")
fiFI("")

T_("Phrase parts")
fiFI("")

T_("Phrase part analysis 1")
fiFI("")

T_("Phrase part analysis 2")
fiFI("")

T_("Rhyme container")
fiFI("")

T_("Action attributes")
fiFI("")

T_("Action parallels")
fiFI("")

T_("Action transitions")
fiFI("")
...
// PACKAGE 'ToolBase' FILE 'ImagePlayerBase.cpp'

T_("Part")
fiFI("Osa")


// PACKAGE 'SongCtrl' FILE 'ActionEditor.cpp'
...
// PACKAGE 'ToolCtrl' FILE 'ImageGenTool.cpp'

T_("Edit")
fiFI("Muokkaa")


// PACKAGE 'SongCtrl' FILE 'EnglishEditor.cpp'
...
// PACKAGE 'ToolCtrl' FILE 'TaskCtrl.cpp'

T_("Idle")
fiFI("Tyhj\303\244k\303\244ynti")


// PACKAGE 'SongCtrl' FILE 'LyricsSolverCtrl.cpp'

T_("#")
fiFI("No.")


// PACKAGE 'SongDataCtrl' FILE 'PhrasePartAnalysis2.cpp'
...
// PACKAGE 'SongDataCtrl' FILE 'Analysis.cpp'
...
// PACKAGE 'ToolBase' FILE 'TranslatorToolBase.cpp'
...
// PACKAGE 'ToolBase' FILE 'ChecklistBase.cpp'
...
// PACKAGE 'SongDataCtrl' FILE 'VirtualPhrases.cpp'
...
// PACKAGE 'SongCtrl' FILE 'LyricsStructure.cpp'
...
// PACKAGE 'SongCtrl' FILE 'LineSetter.cpp'
...
// PACKAGE 'SongCtrl' FILE 'Simplified.lay'
...
// PACKAGE 'SongCtrl' FILE 'ReleaseBriefing.h'
...
// PACKAGE 'SongCtrl' FILE 'ReleaseIdeas.cpp'
...
// PACKAGE 'SongCtrl' FILE 'SongBriefing.cpp'
...
// PACKAGE 'SongDataCtrl' FILE 'ActionParallels.cpp'
...
// PACKAGE 'SongCtrl' FILE 'Checklists.h'
...
// PACKAGE 'SongCtrl' FILE 'ReleaseCoverImage.cpp'
...
// PACKAGE 'SongCtrl' FILE 'Pitching.cpp'
...
// PACKAGE 'SongCtrl' FILE 'NanaEditor.cpp'
...
// PACKAGE 'SongCtrl' FILE 'LinePicker.cpp'
...
T_("Active song structure")
fiFI("")

T_("Name of the structure:")
fiFI("")
...
T_("Description of the song for suggestions")
fiFI("")

T_("Parts in total for suggestions")
fiFI("")

T_("Song bpm")
fiFI("")

T_("Verse length (2 rhymes, 4 bars)")
fiFI("")

T_("Pre-chorus length (2 rhymes, 4 bars)")
fiFI("")

T_("Chorus length (2 rhymes, 4 bars)")
fiFI("")

T_("Bridge length (2 rhymes, 4 bars)")
fiFI("")

T_("Load user's structure")
fiFI("")

T_("Get structure suggestions")
fiFI("")

T_("Get attributes for suggestions")
fiFI("")

T_("Load selected structure")
fiFI("")
...
T_("Scores (Ide,Emo,Hoo,Sha,Val,Com,Sex,Pol,Lov,Soc)")
fiFI("")
...
T_("Secondary word-class")
fiFI("")

T_("Secondary phrase")
fiFI("")

T_("Get new song title")
fiFI("")
...
T_("Processing failed")
fiFI("")


// Checklists.h

T_("Fix the timing for kick, bass, rhythm instruments (compare only two tracks "
     "simultaneously)")
fiFI("")

T_("See the list of (updated) plugin list and consider every plugin in your "
     "list")
fiFI("")

T_("Add proper microphone IR to all tracks")
fiFI("")

T_("Bass and kick harmonics creation with e.g. SyncerSoft Bass Landscapes")
fiFI("")

T_("balance single channels with transient eq e.g. split:eq, TransientEQ")
fiFI("")
...
T_("Song uses dataset")
fiFI("")

T_("Artist's typecast")
fiFI("")

T_("Content's contrast")
fiFI("")

T_("Content's archetype")
fiFI("")

T_("Singing style")
fiFI("")

T_("What is the vision for the song?")
fiFI("")


// LinePicker.cpp

T_("Attribute - Color - Action")
fiFI("")

T_("Action - Color - Attribute")
fiFI("")

T_("Color - Action - Attribute")
fiFI("")

T_("Color - Action group - Attribute - Action value")
fiFI("")
...
T_("Add selected positive attribute")
fiFI("")

T_("Add selected negative attribute")
fiFI("")

T_("Add random")
fiFI("")

T_("Remove active attribute")
fiFI("")

T_("Add random combination")
fiFI("")


// LineStructureEditor.cpp
...
T_("Action thread usage %")
fiFI("")

T_("Rhyme distance limit")
fiFI("")

T_("Set phrase")
fiFI("")

T_("Copy pronounciation to clipboard")
fiFI("")
...
T_("Get all syllables")
fiFI("")

T_("Copy linked word data")
fiFI("")

T_("Debug dump word groups")
fiFI("")

T_("Debug dump phonetic characters")
fiFI("")


// AmbiguousWordPairs.cpp
...
T_("Make virtual phrases")
fiFI("")

T_("Make virtual phrase parts")
fiFI("")


// VirtualPhraseParts.cpp

T_("Structural name")
fiFI("")

T_("Make structure names")
fiFI("")


// PhrasePartAnalysis.cpp

T_("Scores")
fiFI("")

T_("Get phrase colors")
fiFI("")

T_("Get phrase attributes")
fiFI("")

T_("Get phrase actions")
fiFI("")

T_("Get phrase scores")
fiFI("")


// PhrasePartAnalysis2.cpp
...
T_("Get singer profile")
fiFI("")

T_("Get archetypes")
fiFI("")

T_("Get primary human")
fiFI("")

T_("Get secondary human")
fiFI("")

T_("Update action counts")
fiFI("")
...
T_("Manually update data")
fiFI("")

T_("Process rhyme container")
fiFI("")
...
T_("Update action colors")
fiFI("")

T_("Update action attributes")
fiFI("")
...
// ActionTransitions.cpp

T_("Update transitions")
fiFI("")
...
T_("Stop getting line structures")
fiFI("")

T_("Start getting line structures")
fiFI("")

T_("Stop getting structure colors")
fiFI("")

T_("Start getting structure colors")
fiFI("")


// WordnetScoring.cpp

T_("Stop getting wordnet scores")
fiFI("")

T_("Start getting wordnet scores")
fiFI("")

T_("Stop getting colored wordnet scores")
fiFI("")

T_("Start getting colored wordnet scores")
fiFI("")
...
T_("Get attribute distributions")
fiFI("")

T_("Get all words")
fiFI("")

T_("Get all attribute distributions")
fiFI("")
...
T_("Stop getting templates")
fiFI("")

T_("Start getting templates")
fiFI("")


// TemplateScoring.cpp

T_("Stop getting template scores")
fiFI("")

T_("Start getting template scores")
fiFI("")
...
T_("Stop getting line actions")
fiFI("")

T_("Start getting line actions")
fiFI("")


// TaskCtrl.cpp

T_("Retry and skip cache")
fiFI("")
...
T_("Company (if different):")
fiFI("")

T_("Reference program:")
fiFI("")

T_("Origins of the program:")
fiFI("")
...
T_("same end rhyming for both lines")
fiFI("")

T_("internal rhyming for both lines")
fiFI("")

T_("both internal rhyming and end rhyming")
fiFI("")

T_("same end rhyming for 3 lines")
fiFI("")

T_("internal rhyming for 3 lines")
fiFI("")

T_("same end rhyming for all 4 lines")
fiFI("")

T_("rhyming with every 2nd line")
fiFI("")

T_("rhyming with 2nd and 4th lines")
fiFI("")

T_("internal rhyming and rhyming with 2nd and 4th lines")
fiFI("")
