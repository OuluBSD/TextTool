...
TextDataWordnetScoring::TextDataWordnetScoring() {
	Add(hsplit.SizePos());
...
void TextDataWordnetScoring::EnableAll() {
	
}

void TextDataWordnetScoring::DisableAll() {
	
}

void TextDataWordnetScoring::Data() {
...
void TextDataWordnetScoring::DataDataset() {
...
void TextDataWordnetScoring::DataAttribute() {
	if (!attrs.IsCursor())
		return;
...
void TextDataWordnetScoring::DataColor() {
...
void TextDataWordnetScoring::ToolMenu(Bar& bar) {
...
void TextDataWordnetScoring::ToggleGettingWordnetScores(int score_mode) {
	running = !running;
	if (running) {
...
void TextDataWordnetScoring::GetWordnetScores(int batch_i, int score_mode) {
...
void TextDataWordnetScoring::ToggleGettingColorWordnetScores(int score_mode) {
	running = !running;
	if (running) {
...
void TextDataWordnetScoring::GetColorWordnetScores(int batch_i, int score_mode) {
	if (Thread::IsShutdownThreads())
		return;
