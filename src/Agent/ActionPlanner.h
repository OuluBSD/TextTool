...
public:
	static ArrayMap<hash_t, ActionNode> tmp_sub;
...
typedef ActionNode APlanNode;

}

/*template <>	inline bool TerminalTest<Agent::ActionNode>(Agent::ActionNode& n, Agent::ActionNode** prev) {
